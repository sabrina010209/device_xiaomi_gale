package org.lineageos.dt2w.gale;
...
public class DT2WServiceGale extends Service {
    private static final String TAG = "DT2WServiceGale";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.gale.dt2w", dt2wEnabled ? "1" : "0");
        }
